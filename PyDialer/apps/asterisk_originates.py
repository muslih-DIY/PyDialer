...
def originate(endpoint,context='from-internal',extension='s',priority=1):
    ...
    manager.send_action(Originate_Context(channel=f'PJSIP/{endpoint}', context=context, extension=extension,priority=priority))
